...
const About = () => {
    return (<div>
        <div className="container transcript">
            <div className="text-centre"><h1 className="color-dark">About StudyBuddy</h1></div>
            <div className="content ins">
                <div className="row">
                    ...
                    <div className="col-md-7"><p>Everyday people watch one billion hours of videos on YouTube and
                        ...
                        2024). Another interesting fact is that searches related to the term “how to” are growing 70
                        percent
